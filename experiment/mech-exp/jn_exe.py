...
full_data = ExcelDataset(N=181,t0=t0,file_path=datadir+'jn.xlsx',transform=Z_score_scaler)
...
trans_df = pd.DataFrame({"exercise_name":"jn single exeperiment","model":"ConvTrans","Epoch":mse_min_index,"Rp_result":Rp_result,"mae_result":mae_result,\

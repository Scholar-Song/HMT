...
shunxu_str = "jn_nd_hx"
# full_data = ExcelDataset(N=181*3,t0=t0,file_path=datadir+'hx_jn_nd.xlsx',transform=Z_score_scaler) # 0.037
# full_data = ExcelDataset(N=181*3,t0=t0,file_path=datadir+'hx_nd_jn.xlsx',transform=Z_score_scaler) # 0.016
#
# full_data = ExcelDataset(N=181*3,t0=t0,file_path=datadir+'nd_hx_jn.xlsx',transform=Z_score_scaler) # 0.016
# full_data = ExcelDataset(N=181*3,t0=t0,file_path=datadir+'nd_jn_hx.xlsx',transform=Z_score_scaler) # 0.05
#
# full_data = ExcelDataset(N=181*3,t0=t0,file_path=datadir+'jn_hx_nd.xlsx',transform=Z_score_scaler)# 0.037
full_data = ExcelDataset(N=181*3,t0=t0,file_path=datadir+shunxu_str+".xlsx",transform=Z_score_scaler)#0.007
...
trans_df = pd.DataFrame({"exercise_name":shunxu_str,"model":"ConvTrans","Epoch":mse_min_index,"Rp_result":Rp_result,"mae_result":mae_result,\
